...
<head>
    ...
    <!-- App styles -->
    <link rel="stylesheet" href="{{ asset('themes/Sadmin/css/login.css') }}">
...
<div class="container">
    <div id="login-box">
        <div class="logo">
            <img src="{{ asset('themes/Sadmin/img/logo.png') }}" class="img img-responsive"/>
            <h1 class="logo-caption"><span class="tweak">B</span>ienvenue <span class="tweak">V</span>isiteur</h1>
        </div><!-- /.logo -->
        <div class="controls">
            <a href="{{ route('login.steam') }}"><img src="{{ asset('themes/Sadmin/img/signSteam.png') }}" class="img-responsive"></a>
        </div><!-- /.controls -->
    </div><!-- /#login-box -->
</div><!-- /.container -->
