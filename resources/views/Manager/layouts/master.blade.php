...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('storage/dist/css/skins/skin-blue.min.css') }}">
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="{{ url('/') }}" class="logo">
            ...
            <span class="logo-mini"><b>ESX</b></span>
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                ...
                                <p>
                                    {{ Auth::user()->username }} - {{ isset(Auth::user()->Player->jobs) ? Auth::user()->Player->Job->label : 'Sans Emploi' }}
                                    <small>Membre depuis : {{ Auth::user()->created_at->diffforhumans() }} </small>
                                </p>
                            </li>
                            <!-- Menu Footer-->
        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                ...
                <div class="pull-left info">
                    ...
                    <a href="#"> {{ isset(Auth::user()->Player->Job) ?  Auth::user()->Player->Job->Grade->label . " - " . Auth::user()->Player->Job->label : 'Sans Emploi'}}</a>
                </div>
            </div>
